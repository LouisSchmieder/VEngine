...
[inline]
pub fn tex_image3d(target u32, level int, internalFormat int, width int, height int, depth int, border int, format u32, gl_type u32, pixels voidptr) {
...
[inline]
pub fn compressed_tex_image1d(target u32, level int, internalformat u32, width int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage1D(target, level, internalformat, width, border, imageSize,
		data)
}

[inline]
pub fn compressed_tex_image2d(target u32, level int, internalformat u32, width int, height int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize,
		data)
}

[inline]
pub fn compressed_tex_image3d(target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage3D(target, level, internalformat, width, height, depth, border,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image1d(target u32, level int, xoffset int, width int, format u32, imageSize int, data voidptr) {
	C.glCompressedTexSubImage1D(target, level, xoffset, width, format, imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image2d(target u32, level int, xoffset int, yoffset int, width int, height int, format u32, imageSize int, data voidptr) {
	C.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image3d(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
...
[inline]
pub fn sample_coverage(value f32, invert byte) {
...
[inline]
pub fn secondary_color3ubv(v &byte) {
...
[inline]
pub fn is_buffer(buffer u32) byte {
	return C.glIsBuffer(buffer)
}

[inline]
pub fn is_query(id u32) byte {
...
[inline]
pub fn unmap_buffer(target u32) byte {
...
[inline]
pub fn get_active_attrib(program u32, index u32, maxLength int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetActiveAttrib(program, index, maxLength, length, size, gl_type, name)
}

[inline]
pub fn get_active_uniform(program u32, index u32, maxLength int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetActiveUniform(program, index, maxLength, length, size, gl_type, name)
}
...
[inline]
pub fn get_program_info_log(program u32, bufSize int, length &int, infoLog &char) {
...
[inline]
pub fn get_shader_info_log(shader u32, bufSize int, length &int, infoLog &char) {
	C.glGetShaderInfoLog(shader, bufSize, length, infoLog)
}

[inline]
pub fn get_shader_source(obj u32, maxLength int, length &int, source &char) {
	C.glGetShaderSource(obj, maxLength, length, source)
}
...
[inline]
pub fn is_program(program u32) byte {
	return C.glIsProgram(program)
}

[inline]
pub fn is_shader(shader u32) byte {
...
[inline]
pub fn uniform_matrix2fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4fv(location int, count int, transpose byte, value &f32) {
...
[inline]
pub fn vertex_attrib4nub(index u32, x byte, y byte, z byte, w byte) {
	C.glVertexAttrib4Nub(index, x, y, z, w)
}

[inline]
pub fn vertex_attrib4nubv(index u32, v &byte) {
...
[inline]
pub fn vertex_attrib4ubv(index u32, v &byte) {
...
[inline]
pub fn vertex_attrib_pointer(index u32, size int, gl_type u32, normalized byte, stride int, pointer voidptr) {
	C.glVertexAttribPointer(index, size, gl_type, normalized, stride, pointer)
}

[inline]
pub fn uniform_matrix2x3fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2x3fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix2x4fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2x4fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x2fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3x2fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x4fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3x4fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x2fv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix4x2fv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x3fv(location int, count int, transpose byte, value &f32) {
...
[inline]
pub fn bind_frag_data_location(program u32, colorNumber u32, name &char) {
	C.glBindFragDataLocation(program, colorNumber, name)
}
...
[inline]
pub fn color_maski(buf u32, red byte, green byte, blue byte, alpha byte) {
...
[inline]
pub fn get_booleani_v(pname u32, index u32, data &byte) {
...
[inline]
pub fn get_stringi(name u32, index u32) &byte {
...
[inline]
pub fn get_transform_feedback_varying(program u32, index u32, bufSize int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetTransformFeedbackVarying(program, index, bufSize, length, size, gl_type, name)
}
...
[inline]
pub fn is_enabledi(cap u32, index u32) byte {
...
[inline]
pub fn transform_feedback_varyings(program u32, count int, varyings &&char, bufferMode u32) {
...
[inline]
pub fn vertex_attrib_i4ubv(index u32, v0 &byte) {
...
[inline]
pub fn getn_tex_image(tex u32, level int, format u32, gl_type u32, bufSize int, pixels voidptr) {
	C.glGetnTexImage(tex, level, format, gl_type, bufSize, pixels)
}

[inline]
pub fn getn_uniformdv(program u32, location int, bufSize int, params &f64) {
	C.glGetnUniformdv(program, location, bufSize, params)
}
...
[inline]
pub fn specialize_shader(shader u32, pEntryPoint &char, numSpecializationConstants u32, pConstantIndex &u32, pConstantValue &u32) {
	C.glSpecializeShader(shader, pEntryPoint, numSpecializationConstants, pConstantIndex,
		pConstantValue)
}
...
[inline]
pub fn debug_message_callback_amd(callback voidptr, userParam voidptr) {
	C.glDebugMessageCallbackAMD(callback, userParam)
}

[inline]
pub fn debug_message_enable_amd(category u32, severity u32, count int, ids &u32, enabled byte) {
...
[inline]
pub fn blend_equation_separate_indexed_amd(buf u32, modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateIndexedAMD(buf, modeRGB, modeAlpha)
}
...
[inline]
pub fn blend_func_separate_indexed_amd(buf u32, srcRGB u32, dstRGB u32, srcAlpha u32, dstAlpha u32) {
	C.glBlendFuncSeparateIndexedAMD(buf, srcRGB, dstRGB, srcAlpha, dstAlpha)
}

[inline]
pub fn named_renderbuffer_storage_multisample_advanced_amd(renderbuffer u32, samples int, storageSamples int, internalformat u32, width int, height int) {
	C.glNamedRenderbufferStorageMultisampleAdvancedAMD(renderbuffer, samples, storageSamples,
		internalformat, width, height)
}

[inline]
pub fn renderbuffer_storage_multisample_advanced_amd(target u32, samples int, storageSamples int, internalformat u32, width int, height int) {
	C.glRenderbufferStorageMultisampleAdvancedAMD(target, samples, storageSamples, internalformat,
		width, height)
}
...
[inline]
pub fn is_name_amd(identifier u32, name u32) byte {
...
[inline]
pub fn get_perf_monitor_counter_data_amd(monitor u32, pname u32, dataSize int, data &u32, bytesWritten &int) {
	C.glGetPerfMonitorCounterDataAMD(monitor, pname, dataSize, data, bytesWritten)
}
...
[inline]
pub fn get_perf_monitor_counter_string_amd(group u32, counter u32, bufSize int, length &int, counterString &char) {
	C.glGetPerfMonitorCounterStringAMD(group, counter, bufSize, length, counterString)
}

[inline]
pub fn get_perf_monitor_counters_amd(group u32, numCounters &int, maxActiveCounters &int, countersSize int, counters &u32) {
	C.glGetPerfMonitorCountersAMD(group, numCounters, maxActiveCounters, countersSize,
		counters)
}

[inline]
pub fn get_perf_monitor_group_string_amd(group u32, bufSize int, length &int, groupString &char) {
	C.glGetPerfMonitorGroupStringAMD(group, bufSize, length, groupString)
}

[inline]
pub fn get_perf_monitor_groups_amd(numGroups &int, groupsSize int, groups &u32) {
	C.glGetPerfMonitorGroupsAMD(numGroups, groupsSize, groups)
}

[inline]
pub fn select_perf_monitor_counters_amd(monitor u32, enable byte, group u32, numCounters int, counterList &u32) {
	C.glSelectPerfMonitorCountersAMD(monitor, enable, group, numCounters, counterList)
}
...
[inline]
pub fn tex_storage_sparse_amd(target u32, internalFormat u32, width int, height int, depth int, layers int, flags u32) {
	C.glTexStorageSparseAMD(target, internalFormat, width, height, depth, layers, flags)
}

[inline]
pub fn texture_storage_sparse_amd(texture u32, target u32, internalFormat u32, width int, height int, depth int, layers int, flags u32) {
	C.glTextureStorageSparseAMD(texture, target, internalFormat, width, height, depth,
		layers, flags)
}
...
[inline]
pub fn blit_framebuffer_angle(srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glBlitFramebufferANGLE(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask,
		filter)
}
...
[inline]
pub fn is_query_angle(id u32) byte {
...
[inline]
pub fn copy_texture_levels_apple(destinationTexture u32, sourceTexture u32, sourceBaseLevel int, sourceLevelCount int) {
	C.glCopyTextureLevelsAPPLE(destinationTexture, sourceTexture, sourceBaseLevel, sourceLevelCount)
}
...
[inline]
pub fn is_fence_apple(fence u32) byte {
...
[inline]
pub fn test_fence_apple(fence u32) byte {
	return C.glTestFenceAPPLE(fence)
}

[inline]
pub fn test_object_apple(object u32, name u32) byte {
...
[inline]
pub fn get_object_parameteriv_apple(objectType u32, name u32, pname u32, params &int) {
	C.glGetObjectParameterivAPPLE(objectType, name, pname, params)
}

[inline]
pub fn object_purgeable_apple(objectType u32, name u32, option u32) u32 {
	return C.glObjectPurgeableAPPLE(objectType, name, option)
}

[inline]
pub fn object_unpurgeable_apple(objectType u32, name u32, option u32) u32 {
	return C.glObjectUnpurgeableAPPLE(objectType, name, option)
}

[inline]
pub fn client_wait_sync_apple(gl_sync voidptr, flags u32, timeout u64) u32 {
	return C.glClientWaitSyncAPPLE(gl_sync, flags, timeout)
}

[inline]
pub fn delete_sync_apple(gl_sync voidptr) {
	C.glDeleteSyncAPPLE(gl_sync)
}
...
[inline]
pub fn get_synciv_apple(gl_sync voidptr, pname u32, bufSize int, length &int, values &int) {
	C.glGetSyncivAPPLE(gl_sync, pname, bufSize, length, values)
}

[inline]
pub fn is_sync_apple(gl_sync voidptr) byte {
	return C.glIsSyncAPPLE(gl_sync)
}

[inline]
pub fn wait_sync_apple(gl_sync voidptr, flags u32, timeout u64) {
	C.glWaitSyncAPPLE(gl_sync, flags, timeout)
}
...
[inline]
pub fn is_vertex_array_apple(array u32) byte {
...
[inline]
pub fn is_vertex_attrib_enabled_apple(index u32, pname u32) byte {
...
[inline]
pub fn primitive_bounding_box_arb(minX f32, minY f32, minZ f32, minW f32, maxX f32, maxY f32, maxZ f32, maxW f32) {
	C.glPrimitiveBoundingBoxARB(minX, minY, minZ, minW, maxX, maxY, maxZ, maxW)
}
...
[inline]
pub fn get_image_handle_arb(texture u32, level int, layered byte, layer int, format u32) u64 {
...
[inline]
pub fn is_image_handle_resident_arb(handle u64) byte {
	return C.glIsImageHandleResidentARB(handle)
}

[inline]
pub fn is_texture_handle_resident_arb(handle u64) byte {
...
[inline]
pub fn bind_frag_data_location_indexed(program u32, colorNumber u32, index u32, name &char) {
...
pub fn copy_image_sub_data(srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, srcWidth int, srcHeight int, srcDepth int) {
	C.glCopyImageSubData(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget,
		dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth)
}

[inline]
pub fn debug_message_callback_arb(callback voidptr, userParam voidptr) {
	C.glDebugMessageCallbackARB(callback, userParam)
}

[inline]
pub fn debug_message_control_arb(source u32, gl_type u32, severity u32, count int, ids &u32, enabled byte) {
...
[inline]
pub fn get_debug_message_log_arb(count u32, bufSize int, sources &u32, types &u32, ids &u32, severities &u32, lengths &int, messageLog &char) u32 {
	return C.glGetDebugMessageLogARB(count, bufSize, sources, types, ids, severities,
		lengths, messageLog)
}
...
pub fn blit_named_framebuffer(readFramebuffer u32, drawFramebuffer u32, srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glBlitNamedFramebuffer(readFramebuffer, drawFramebuffer, srcX0, srcY0, srcX1, srcY1,
...
[inline]
pub fn compressed_texture_sub_image1d(texture u32, level int, xoffset int, width int, format u32, imageSize int, data voidptr) {
	C.glCompressedTextureSubImage1D(texture, level, xoffset, width, format, imageSize,
		data)
}

[inline]
pub fn compressed_texture_sub_image2d(texture u32, level int, xoffset int, yoffset int, width int, height int, format u32, imageSize int, data voidptr) {
	C.glCompressedTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format,
		imageSize, data)
}

[inline]
pub fn compressed_texture_sub_image3d(texture u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
	C.glCompressedTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width,
		height, depth, format, imageSize, data)
}

[inline]
pub fn copy_named_buffer_sub_data(readBuffer u32, writeBuffer u32, readOffset i64, writeOffset i64, size i64) {
...
[inline]
pub fn get_texture_image(texture u32, level int, format u32, gl_type u32, bufSize int, pixels voidptr) {
	C.glGetTextureImage(texture, level, format, gl_type, bufSize, pixels)
}
...
pub fn invalidate_named_framebuffer_sub_data(framebuffer u32, numAttachments int, attachments &u32, x int, y int, width int, height int) {
	C.glInvalidateNamedFramebufferSubData(framebuffer, numAttachments, attachments, x,
		y, width, height)
}
...
[inline]
pub fn texture_storage2dmultisample(texture u32, samples int, internalformat u32, width int, height int, fixedsamplelocations byte) {
...
[inline]
pub fn texture_storage3dmultisample(texture u32, samples int, internalformat u32, width int, height int, depth int, fixedsamplelocations byte) {
...
[inline]
pub fn unmap_named_buffer(buffer u32) byte {
...
[inline]
pub fn vertex_array_attrib_format(vaobj u32, attribindex u32, size int, gl_type u32, normalized byte, relativeoffset u32) {
...
[inline]
pub fn blend_equation_separatei_arb(buf u32, modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateiARB(buf, modeRGB, modeAlpha)
}
...
[inline]
pub fn blend_func_separatei_arb(buf u32, srcRGB u32, dstRGB u32, srcAlpha u32, dstAlpha u32) {
	C.glBlendFuncSeparateiARB(buf, srcRGB, dstRGB, srcAlpha, dstAlpha)
}
...
pub fn blit_framebuffer(srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask,
		filter)
}
...
[inline]
pub fn is_framebuffer(framebuffer u32) byte {
	return C.glIsFramebuffer(framebuffer)
}

[inline]
pub fn is_renderbuffer(renderbuffer u32) byte {
...
pub fn get_program_binary(program u32, bufSize int, length &int, binaryFormat &u32, binary voidptr) {
	C.glGetProgramBinary(program, bufSize, length, binaryFormat, binary)
}
...
[inline]
pub fn get_texture_sub_image(texture u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, gl_type u32, bufSize int, pixels voidptr) {
	C.glGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth,
		format, gl_type, bufSize, pixels)
}

[inline]
pub fn specialize_shader_arb(shader u32, pEntryPoint &char, numSpecializationConstants u32, pConstantIndex &u32, pConstantValue &u32) {
	C.glSpecializeShaderARB(shader, pEntryPoint, numSpecializationConstants, pConstantIndex,
		pConstantValue)
}
...
[inline]
pub fn uniform_matrix2dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix2dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix2x3dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix2x3dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix2x4dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix2x4dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix3dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x2dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix3x2dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x4dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix3x4dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix4dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x2dv(location int, count int, transpose byte, value &f64) {
	C.glUniformMatrix4x2dv(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x3dv(location int, count int, transpose byte, value &f64) {
...
[inline]
pub fn getn_uniformi64v_arb(program u32, location int, bufSize int, params &i64) {
	C.glGetnUniformi64vARB(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformui64v_arb(program u32, location int, bufSize int, params &u64) {
	C.glGetnUniformui64vARB(program, location, bufSize, params)
}
...
[inline]
pub fn get_histogram(target u32, reset byte, format u32, gl_type u32, values voidptr) {
...
[inline]
pub fn get_minmax(target u32, reset byte, format u32, types u32, values voidptr) {
...
[inline]
pub fn histogram(target u32, width int, internalformat u32, sink byte) {
	C.glHistogram(target, width, internalformat, sink)
}

[inline]
pub fn minmax(target u32, internalformat u32, sink byte) {
...
pub fn get_internalformativ(target u32, internalformat u32, pname u32, bufSize int, params &int) {
	C.glGetInternalformativ(target, internalformat, pname, bufSize, params)
}

[inline]
pub fn get_internalformati64v(target u32, internalformat u32, pname u32, bufSize int, params &i64) {
	C.glGetInternalformati64v(target, internalformat, pname, bufSize, params)
}
...
pub fn invalidate_framebuffer(target u32, numAttachments int, attachments &u32) {
	C.glInvalidateFramebuffer(target, numAttachments, attachments)
}

[inline]
pub fn invalidate_sub_framebuffer(target u32, numAttachments int, attachments &u32, x int, y int, width int, height int) {
	C.glInvalidateSubFramebuffer(target, numAttachments, attachments, x, y, width, height)
}
...
[inline]
pub fn matrix_indexubv_arb(size int, indices &byte) {
...
[inline]
pub fn sample_coverage_arb(value f32, invert byte) {
...
[inline]
pub fn is_query_arb(id u32) byte {
...
pub fn get_program_interfaceiv(program u32, programInterface u32, pname u32, params &int) {
	C.glGetProgramInterfaceiv(program, programInterface, pname, params)
}

[inline]
pub fn get_program_resource_index(program u32, programInterface u32, name &char) u32 {
	return C.glGetProgramResourceIndex(program, programInterface, name)
}

[inline]
pub fn get_program_resource_location(program u32, programInterface u32, name &char) int {
	return C.glGetProgramResourceLocation(program, programInterface, name)
}

[inline]
pub fn get_program_resource_location_index(program u32, programInterface u32, name &char) int {
	return C.glGetProgramResourceLocationIndex(program, programInterface, name)
}

[inline]
pub fn get_program_resource_name(program u32, programInterface u32, index u32, bufSize int, length &int, name &char) {
	C.glGetProgramResourceName(program, programInterface, index, bufSize, length, name)
}
...
pub fn get_program_resourceiv(program u32, programInterface u32, index u32, propCount int, props &u32, bufSize int, length &int, params &int) {
	C.glGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize,
		length, params)
}
...
[inline]
pub fn getn_color_table_arb(target u32, format u32, gl_type u32, bufSize int, table voidptr) {
	C.glGetnColorTableARB(target, format, gl_type, bufSize, table)
}

[inline]
pub fn getn_compressed_tex_image_arb(target u32, lod int, bufSize int, img voidptr) {
	C.glGetnCompressedTexImageARB(target, lod, bufSize, img)
}

[inline]
pub fn getn_convolution_filter_arb(target u32, format u32, gl_type u32, bufSize int, image voidptr) {
	C.glGetnConvolutionFilterARB(target, format, gl_type, bufSize, image)
}

[inline]
pub fn getn_histogram_arb(target u32, reset byte, format u32, gl_type u32, bufSize int, values voidptr) {
	C.glGetnHistogramARB(target, reset, format, gl_type, bufSize, values)
}

[inline]
pub fn getn_mapdv_arb(target u32, query u32, bufSize int, v &f64) {
	C.glGetnMapdvARB(target, query, bufSize, v)
}

[inline]
pub fn getn_mapfv_arb(target u32, query u32, bufSize int, v &f32) {
	C.glGetnMapfvARB(target, query, bufSize, v)
}

[inline]
pub fn getn_mapiv_arb(target u32, query u32, bufSize int, v &int) {
	C.glGetnMapivARB(target, query, bufSize, v)
}

[inline]
pub fn getn_minmax_arb(target u32, reset byte, format u32, gl_type u32, bufSize int, values voidptr) {
	C.glGetnMinmaxARB(target, reset, format, gl_type, bufSize, values)
}

[inline]
pub fn getn_pixel_mapfv_arb(gl_map u32, bufSize int, values &f32) {
	C.glGetnPixelMapfvARB(gl_map, bufSize, values)
}

[inline]
pub fn getn_pixel_mapuiv_arb(gl_map u32, bufSize int, values &u32) {
	C.glGetnPixelMapuivARB(gl_map, bufSize, values)
}

[inline]
pub fn getn_pixel_mapusv_arb(gl_map u32, bufSize int, values &u16) {
	C.glGetnPixelMapusvARB(gl_map, bufSize, values)
}

[inline]
pub fn getn_polygon_stipple_arb(bufSize int, pattern &byte) {
	C.glGetnPolygonStippleARB(bufSize, pattern)
}

[inline]
pub fn getn_separable_filter_arb(target u32, format u32, gl_type u32, rowBufSize int, row voidptr, columnBufSize int, column voidptr, span voidptr) {
	C.glGetnSeparableFilterARB(target, format, gl_type, rowBufSize, row, columnBufSize,
		column, span)
}

[inline]
pub fn getn_tex_image_arb(target u32, level int, format u32, gl_type u32, bufSize int, img voidptr) {
	C.glGetnTexImageARB(target, level, format, gl_type, bufSize, img)
}

[inline]
pub fn getn_uniformdv_arb(program u32, location int, bufSize int, params &f64) {
	C.glGetnUniformdvARB(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformfv_arb(program u32, location int, bufSize int, params &f32) {
	C.glGetnUniformfvARB(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformiv_arb(program u32, location int, bufSize int, params &int) {
	C.glGetnUniformivARB(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformuiv_arb(program u32, location int, bufSize int, params &u32) {
	C.glGetnUniformuivARB(program, location, bufSize, params)
}

[inline]
pub fn readn_pixels_arb(x int, y int, width int, height int, format u32, gl_type u32, bufSize int, data voidptr) {
	C.glReadnPixelsARB(x, y, width, height, format, gl_type, bufSize, data)
}
...
[inline]
pub fn is_sampler(sampler u32) byte {
...
[inline]
pub fn get_program_pipeline_info_log(pipeline u32, bufSize int, length &int, infoLog &char) {
	C.glGetProgramPipelineInfoLog(pipeline, bufSize, length, infoLog)
}
...
[inline]
pub fn is_program_pipeline(pipeline u32) byte {
...
[inline]
pub fn program_uniform_matrix2dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix2dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x3dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix2x3dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x3fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2x3fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x4dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix2x4dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x4fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2x4fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix3dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x2dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix3x2dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x2fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3x2fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x4dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix3x4dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x4fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3x4fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix4dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix4fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x2dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix4x2dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x2fv(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix4x2fv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x3dv(program u32, location int, count int, transpose byte, value &f64) {
	C.glProgramUniformMatrix4x3dv(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x3fv(program u32, location int, count int, transpose byte, value &f32) {
...
pub fn get_active_atomic_counter_bufferiv(program u32, bufferIndex u32, pname u32, params &int) {
	C.glGetActiveAtomicCounterBufferiv(program, bufferIndex, pname, params)
}

[inline]
pub fn bind_image_texture(unit u32, texture u32, level int, layered byte, layer int, access u32, format u32) {
...
[inline]
pub fn attach_object_arb(containerObj u32, obj u32) {
	C.glAttachObjectARB(containerObj, obj)
}

[inline]
pub fn compile_shader_arb(shaderObj u32) {
	C.glCompileShaderARB(shaderObj)
}
...
[inline]
pub fn create_shader_object_arb(shaderType u32) u32 {
	return C.glCreateShaderObjectARB(shaderType)
}
...
[inline]
pub fn detach_object_arb(containerObj u32, attachedObj u32) {
	C.glDetachObjectARB(containerObj, attachedObj)
}

[inline]
pub fn get_active_uniform_arb(programObj u32, index u32, maxLength int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetActiveUniformARB(programObj, index, maxLength, length, size, gl_type, name)
}

[inline]
pub fn get_attached_objects_arb(containerObj u32, maxCount int, count &int, obj &u32) {
	C.glGetAttachedObjectsARB(containerObj, maxCount, count, obj)
}
...
[inline]
pub fn get_info_log_arb(obj u32, maxLength int, length &int, infoLog &char) {
	C.glGetInfoLogARB(obj, maxLength, length, infoLog)
}
...
[inline]
pub fn get_shader_source_arb(obj u32, maxLength int, length &int, source &char) {
	C.glGetShaderSourceARB(obj, maxLength, length, source)
}

[inline]
pub fn get_uniform_location_arb(programObj u32, name &char) int {
	return C.glGetUniformLocationARB(programObj, name)
}

[inline]
pub fn get_uniformfv_arb(programObj u32, location int, params &f32) {
	C.glGetUniformfvARB(programObj, location, params)
}

[inline]
pub fn get_uniformiv_arb(programObj u32, location int, params &int) {
	C.glGetUniformivARB(programObj, location, params)
}

[inline]
pub fn link_program_arb(programObj u32) {
	C.glLinkProgramARB(programObj)
}

[inline]
pub fn shader_source_arb(shaderObj u32, count int, gl_string &&char, length &int) {
	C.glShaderSourceARB(shaderObj, count, gl_string, length)
}
...
[inline]
pub fn uniform_matrix2fv_arb(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2fvARB(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3fv_arb(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3fvARB(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4fv_arb(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix4fvARB(location, count, transpose, value)
}

[inline]
pub fn use_program_object_arb(programObj u32) {
	C.glUseProgramObjectARB(programObj)
}

[inline]
pub fn validate_program_arb(programObj u32) {
	C.glValidateProgramARB(programObj)
}
...
[inline]
pub fn get_named_string_arb(namelen int, name &char, bufSize int, stringlen &int, gl_string &char) {
	C.glGetNamedStringARB(namelen, name, bufSize, stringlen, gl_string)
}
...
[inline]
pub fn is_named_string_arb(namelen int, name &char) byte {
...
[inline]
pub fn buffer_page_commitment_arb(target u32, offset i64, size i64, commit byte) {
	C.glBufferPageCommitmentARB(target, offset, size, commit)
}

[inline]
pub fn tex_page_commitment_arb(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, commit byte) {
	C.glTexPageCommitmentARB(target, level, xoffset, yoffset, zoffset, width, height,
		depth, commit)
}

[inline]
pub fn client_wait_sync(gl_sync voidptr, flags u32, timeout u64) u32 {
	return C.glClientWaitSync(gl_sync, flags, timeout)
}

[inline]
pub fn delete_sync(gl_sync voidptr) {
	C.glDeleteSync(gl_sync)
}
...
[inline]
pub fn get_synciv(gl_sync voidptr, pname u32, bufSize int, length &int, values &int) {
	C.glGetSynciv(gl_sync, pname, bufSize, length, values)
}

[inline]
pub fn is_sync(gl_sync voidptr) byte {
	return C.glIsSync(gl_sync)
}

[inline]
pub fn wait_sync(gl_sync voidptr, flags u32, timeout u64) {
	C.glWaitSync(gl_sync, flags, timeout)
}
...
[inline]
pub fn compressed_tex_image1darb(target u32, level int, internalformat u32, width int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage1DARB(target, level, internalformat, width, border, imageSize,
		data)
}

[inline]
pub fn compressed_tex_image2darb(target u32, level int, internalformat u32, width int, height int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage2DARB(target, level, internalformat, width, height, border,
		imageSize, data)
}

[inline]
pub fn compressed_tex_image3darb(target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage3DARB(target, level, internalformat, width, height, depth, border,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image1darb(target u32, level int, xoffset int, width int, format u32, imageSize int, data voidptr) {
	C.glCompressedTexSubImage1DARB(target, level, xoffset, width, format, imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image2darb(target u32, level int, xoffset int, yoffset int, width int, height int, format u32, imageSize int, data voidptr) {
	C.glCompressedTexSubImage2DARB(target, level, xoffset, yoffset, width, height, format,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image3darb(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
...
[inline]
pub fn tex_image2dmultisample(target u32, samples int, internalformat u32, width int, height int, fixedsamplelocations byte) {
	C.glTexImage2DMultisample(target, samples, internalformat, width, height, fixedsamplelocations)
}

[inline]
pub fn tex_image3dmultisample(target u32, samples int, internalformat u32, width int, height int, depth int, fixedsamplelocations byte) {
...
[inline]
pub fn tex_storage2dmultisample(target u32, samples int, internalformat u32, width int, height int, fixedsamplelocations byte) {
	C.glTexStorage2DMultisample(target, samples, internalformat, width, height, fixedsamplelocations)
}

[inline]
pub fn tex_storage3dmultisample(target u32, samples int, internalformat u32, width int, height int, depth int, fixedsamplelocations byte) {
	C.glTexStorage3DMultisample(target, samples, internalformat, width, height, depth,
		fixedsamplelocations)
}

[inline]
pub fn texture_storage2dmultisample_ext(texture u32, target u32, samples int, internalformat u32, width int, height int, fixedsamplelocations byte) {
	C.glTextureStorage2DMultisampleEXT(texture, target, samples, internalformat, width,
		height, fixedsamplelocations)
}

[inline]
pub fn texture_storage3dmultisample_ext(texture u32, target u32, samples int, internalformat u32, width int, height int, depth int, fixedsamplelocations byte) {
...
[inline]
pub fn is_transform_feedback(id u32) byte {
...
[inline]
pub fn get_active_uniform_block_name(program u32, uniformBlockIndex u32, bufSize int, length &int, uniformBlockName &char) {
	C.glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, uniformBlockName)
}

[inline]
pub fn get_active_uniform_blockiv(program u32, uniformBlockIndex u32, pname u32, params &int) {
	C.glGetActiveUniformBlockiv(program, uniformBlockIndex, pname, params)
}

[inline]
pub fn get_active_uniform_name(program u32, uniformIndex u32, bufSize int, length &int, uniformName &char) {
	C.glGetActiveUniformName(program, uniformIndex, bufSize, length, uniformName)
}

[inline]
pub fn get_active_uniformsiv(program u32, uniformCount int, uniformIndices &u32, pname u32, params &int) {
	C.glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname, params)
}
...
[inline]
pub fn get_uniform_block_index(program u32, uniformBlockName &char) u32 {
	return C.glGetUniformBlockIndex(program, uniformBlockName)
}

[inline]
pub fn get_uniform_indices(program u32, uniformCount int, uniformNames &&char, uniformIndices &u32) {
	C.glGetUniformIndices(program, uniformCount, uniformNames, uniformIndices)
}
...
[inline]
pub fn is_vertex_array(array u32) byte {
...
[inline]
pub fn vertex_array_vertex_attrib_format_ext(vaobj u32, attribindex u32, size int, gl_type u32, normalized byte, relativeoffset u32) {
...
[inline]
pub fn vertex_attrib_format(attribindex u32, size int, gl_type u32, normalized byte, relativeoffset u32) {
...
[inline]
pub fn weightubv_arb(size int, weights &byte) {
...
[inline]
pub fn is_buffer_arb(buffer u32) byte {
...
[inline]
pub fn unmap_buffer_arb(target u32) byte {
...
[inline]
pub fn is_program_arb(program u32) byte {
...
[inline]
pub fn vertex_attrib4nub_arb(index u32, x byte, y byte, z byte, w byte) {
	C.glVertexAttrib4NubARB(index, x, y, z, w)
}

[inline]
pub fn vertex_attrib4nubv_arb(index u32, v &byte) {
...
[inline]
pub fn vertex_attrib4ubv_arb(index u32, v &byte) {
...
[inline]
pub fn vertex_attrib_pointer_arb(index u32, size int, gl_type u32, normalized byte, stride int, pointer voidptr) {
	C.glVertexAttribPointerARB(index, size, gl_type, normalized, stride, pointer)
}

[inline]
pub fn bind_attrib_location_arb(programObj u32, index u32, name &char) {
	C.glBindAttribLocationARB(programObj, index, name)
}

[inline]
pub fn get_active_attrib_arb(programObj u32, index u32, maxLength int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetActiveAttribARB(programObj, index, maxLength, length, size, gl_type, name)
}

[inline]
pub fn get_attrib_location_arb(programObj u32, name &char) int {
	return C.glGetAttribLocationARB(programObj, name)
}
...
[inline]
pub fn vertex_attrib_p1ui(index u32, gl_type u32, normalized byte, value u32) {
	C.glVertexAttribP1ui(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p1uiv(index u32, gl_type u32, normalized byte, value &u32) {
	C.glVertexAttribP1uiv(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p2ui(index u32, gl_type u32, normalized byte, value u32) {
	C.glVertexAttribP2ui(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p2uiv(index u32, gl_type u32, normalized byte, value &u32) {
	C.glVertexAttribP2uiv(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p3ui(index u32, gl_type u32, normalized byte, value u32) {
	C.glVertexAttribP3ui(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p3uiv(index u32, gl_type u32, normalized byte, value &u32) {
	C.glVertexAttribP3uiv(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p4ui(index u32, gl_type u32, normalized byte, value u32) {
	C.glVertexAttribP4ui(index, gl_type, normalized, value)
}

[inline]
pub fn vertex_attrib_p4uiv(index u32, gl_type u32, normalized byte, value &u32) {
...
[inline]
pub fn alpha_fragment_op1ati(op u32, dst u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32) {
	C.glAlphaFragmentOp1ATI(op, dst, dstMod, arg1, arg1Rep, arg1Mod)
}

[inline]
pub fn alpha_fragment_op2ati(op u32, dst u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32, arg2 u32, arg2Rep u32, arg2Mod u32) {
	C.glAlphaFragmentOp2ATI(op, dst, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod)
}

[inline]
pub fn alpha_fragment_op3ati(op u32, dst u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32, arg2 u32, arg2Rep u32, arg2Mod u32, arg3 u32, arg3Rep u32, arg3Mod u32) {
	C.glAlphaFragmentOp3ATI(op, dst, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep, arg2Mod,
...
[inline]
pub fn color_fragment_op1ati(op u32, dst u32, dstMask u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32) {
	C.glColorFragmentOp1ATI(op, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod)
}

[inline]
pub fn color_fragment_op2ati(op u32, dst u32, dstMask u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32, arg2 u32, arg2Rep u32, arg2Mod u32) {
	C.glColorFragmentOp2ATI(op, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep,
		arg2Mod)
}

[inline]
pub fn color_fragment_op3ati(op u32, dst u32, dstMask u32, dstMod u32, arg1 u32, arg1Rep u32, arg1Mod u32, arg2 u32, arg2Rep u32, arg2Mod u32, arg3 u32, arg3Rep u32, arg3Mod u32) {
	C.glColorFragmentOp3ATI(op, dst, dstMask, dstMod, arg1, arg1Rep, arg1Mod, arg2, arg2Rep,
...
[inline]
pub fn is_object_buffer_ati(buffer u32) byte {
...
[inline]
pub fn vertex_attrib_array_object_ati(index u32, size int, gl_type u32, normalized byte, stride int, buffer u32, offset u32) {
...
[inline]
pub fn blend_equation_separate_ext(modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateEXT(modeRGB, modeAlpha)
}

[inline]
pub fn bind_frag_data_location_indexed_ext(program u32, colorNumber u32, index u32, name &char) {
	C.glBindFragDataLocationIndexedEXT(program, colorNumber, index, name)
}
...
[inline]
pub fn get_program_resource_location_index_ext(program u32, programInterface u32, name &char) int {
	return C.glGetProgramResourceLocationIndexEXT(program, programInterface, name)
}

[inline]
pub fn blend_func_separate_ext(sfactorRGB u32, dfactorRGB u32, sfactorAlpha u32, dfactorAlpha u32) {
	C.glBlendFuncSeparateEXT(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha)
}
...
[inline]
pub fn copy_image_sub_data_ext(srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, srcWidth int, srcHeight int, srcDepth int) {
	C.glCopyImageSubDataEXT(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget,
		dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth)
}
...
[inline]
pub fn get_object_label_ext(gl_type u32, object u32, bufSize int, length &int, label &char) {
	C.glGetObjectLabelEXT(gl_type, object, bufSize, length, label)
}
...
[inline]
pub fn compressed_multi_tex_image1dext(texunit u32, target u32, level int, internalformat u32, width int, border int, imageSize int, data voidptr) {
	C.glCompressedMultiTexImage1DEXT(texunit, target, level, internalformat, width, border,
		imageSize, data)
}

[inline]
pub fn compressed_multi_tex_image2dext(texunit u32, target u32, level int, internalformat u32, width int, height int, border int, imageSize int, data voidptr) {
	C.glCompressedMultiTexImage2DEXT(texunit, target, level, internalformat, width, height,
		border, imageSize, data)
}

[inline]
pub fn compressed_multi_tex_image3dext(texunit u32, target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedMultiTexImage3DEXT(texunit, target, level, internalformat, width, height,
		depth, border, imageSize, data)
}

[inline]
pub fn compressed_multi_tex_sub_image1dext(texunit u32, target u32, level int, xoffset int, width int, format u32, imageSize int, data voidptr) {
	C.glCompressedMultiTexSubImage1DEXT(texunit, target, level, xoffset, width, format,
		imageSize, data)
}

[inline]
pub fn compressed_multi_tex_sub_image2dext(texunit u32, target u32, level int, xoffset int, yoffset int, width int, height int, format u32, imageSize int, data voidptr) {
	C.glCompressedMultiTexSubImage2DEXT(texunit, target, level, xoffset, yoffset, width,
		height, format, imageSize, data)
}

[inline]
pub fn compressed_multi_tex_sub_image3dext(texunit u32, target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
	C.glCompressedMultiTexSubImage3DEXT(texunit, target, level, xoffset, yoffset, zoffset,
		width, height, depth, format, imageSize, data)
}

[inline]
pub fn compressed_texture_image1dext(texture u32, target u32, level int, internalformat u32, width int, border int, imageSize int, data voidptr) {
	C.glCompressedTextureImage1DEXT(texture, target, level, internalformat, width, border,
		imageSize, data)
}

[inline]
pub fn compressed_texture_image2dext(texture u32, target u32, level int, internalformat u32, width int, height int, border int, imageSize int, data voidptr) {
	C.glCompressedTextureImage2DEXT(texture, target, level, internalformat, width, height,
		border, imageSize, data)
}

[inline]
pub fn compressed_texture_image3dext(texture u32, target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedTextureImage3DEXT(texture, target, level, internalformat, width, height,
		depth, border, imageSize, data)
}

[inline]
pub fn compressed_texture_sub_image1dext(texture u32, target u32, level int, xoffset int, width int, format u32, imageSize int, data voidptr) {
	C.glCompressedTextureSubImage1DEXT(texture, target, level, xoffset, width, format,
		imageSize, data)
}

[inline]
pub fn compressed_texture_sub_image2dext(texture u32, target u32, level int, xoffset int, yoffset int, width int, height int, format u32, imageSize int, data voidptr) {
	C.glCompressedTextureSubImage2DEXT(texture, target, level, xoffset, yoffset, width,
		height, format, imageSize, data)
}

[inline]
pub fn compressed_texture_sub_image3dext(texture u32, target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
...
[inline]
pub fn matrix_frustum_ext(matrixMode u32, l f64, r f64, b f64, t f64, n f64, f f64) {
	C.glMatrixFrustumEXT(matrixMode, l, r, b, t, n, f)
}

[inline]
pub fn matrix_load_identity_ext(matrixMode u32) {
	C.glMatrixLoadIdentityEXT(matrixMode)
}

[inline]
pub fn matrix_load_transposed_ext(matrixMode u32, m &f64) {
	C.glMatrixLoadTransposedEXT(matrixMode, m)
}

[inline]
pub fn matrix_load_transposef_ext(matrixMode u32, m &f32) {
	C.glMatrixLoadTransposefEXT(matrixMode, m)
}

[inline]
pub fn matrix_loadd_ext(matrixMode u32, m &f64) {
	C.glMatrixLoaddEXT(matrixMode, m)
}

[inline]
pub fn matrix_loadf_ext(matrixMode u32, m &f32) {
	C.glMatrixLoadfEXT(matrixMode, m)
}

[inline]
pub fn matrix_mult_transposed_ext(matrixMode u32, m &f64) {
	C.glMatrixMultTransposedEXT(matrixMode, m)
}

[inline]
pub fn matrix_mult_transposef_ext(matrixMode u32, m &f32) {
	C.glMatrixMultTransposefEXT(matrixMode, m)
}

[inline]
pub fn matrix_multd_ext(matrixMode u32, m &f64) {
	C.glMatrixMultdEXT(matrixMode, m)
}

[inline]
pub fn matrix_multf_ext(matrixMode u32, m &f32) {
	C.glMatrixMultfEXT(matrixMode, m)
}

[inline]
pub fn matrix_ortho_ext(matrixMode u32, l f64, r f64, b f64, t f64, n f64, f f64) {
	C.glMatrixOrthoEXT(matrixMode, l, r, b, t, n, f)
}

[inline]
pub fn matrix_pop_ext(matrixMode u32) {
	C.glMatrixPopEXT(matrixMode)
}

[inline]
pub fn matrix_push_ext(matrixMode u32) {
	C.glMatrixPushEXT(matrixMode)
}

[inline]
pub fn matrix_rotated_ext(matrixMode u32, angle f64, x f64, y f64, z f64) {
	C.glMatrixRotatedEXT(matrixMode, angle, x, y, z)
}

[inline]
pub fn matrix_rotatef_ext(matrixMode u32, angle f32, x f32, y f32, z f32) {
	C.glMatrixRotatefEXT(matrixMode, angle, x, y, z)
}

[inline]
pub fn matrix_scaled_ext(matrixMode u32, x f64, y f64, z f64) {
	C.glMatrixScaledEXT(matrixMode, x, y, z)
}

[inline]
pub fn matrix_scalef_ext(matrixMode u32, x f32, y f32, z f32) {
	C.glMatrixScalefEXT(matrixMode, x, y, z)
}

[inline]
pub fn matrix_translated_ext(matrixMode u32, x f64, y f64, z f64) {
	C.glMatrixTranslatedEXT(matrixMode, x, y, z)
}

[inline]
pub fn matrix_translatef_ext(matrixMode u32, x f32, y f32, z f32) {
	C.glMatrixTranslatefEXT(matrixMode, x, y, z)
}
...
[inline]
pub fn named_copy_buffer_sub_data_ext(readBuffer u32, writeBuffer u32, readOffset i64, writeOffset i64, size i64) {
	C.glNamedCopyBufferSubDataEXT(readBuffer, writeBuffer, readOffset, writeOffset, size)
}
...
[inline]
pub fn named_renderbuffer_storage_multisample_coverage_ext(renderbuffer u32, coverageSamples int, colorSamples int, internalformat u32, width int, height int) {
	C.glNamedRenderbufferStorageMultisampleCoverageEXT(renderbuffer, coverageSamples,
...
[inline]
pub fn program_uniform_matrix2fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x3fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2x3fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix2x4fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix2x4fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x2fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3x2fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix3x4fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix3x4fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix4fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x2fv_ext(program u32, location int, count int, transpose byte, value &f32) {
	C.glProgramUniformMatrix4x2fvEXT(program, location, count, transpose, value)
}

[inline]
pub fn program_uniform_matrix4x3fv_ext(program u32, location int, count int, transpose byte, value &f32) {
...
[inline]
pub fn unmap_named_buffer_ext(buffer u32) byte {
...
[inline]
pub fn vertex_array_vertex_attrib_offset_ext(vaobj u32, buffer u32, index u32, size int, gl_type u32, normalized byte, stride int, offset i64) {
...
[inline]
pub fn discard_framebuffer_ext(target u32, numAttachments int, attachments &u32) {
	C.glDiscardFramebufferEXT(target, numAttachments, attachments)
}
...
[inline]
pub fn is_query_ext(id u32) byte {
...
[inline]
pub fn color_mask_indexed_ext(buf u32, r byte, g byte, b byte, a byte) {
...
[inline]
pub fn get_boolean_indexedv_ext(value u32, index u32, data &byte) {
...
[inline]
pub fn is_enabled_indexed_ext(target u32, index u32) byte {
	return C.glIsEnabledIndexedEXT(target, index)
}

[inline]
pub fn blend_equation_separatei_ext(buf u32, modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateiEXT(buf, modeRGB, modeAlpha)
}
...
[inline]
pub fn blend_func_separatei_ext(buf u32, srcRGB u32, dstRGB u32, srcAlpha u32, dstAlpha u32) {
	C.glBlendFuncSeparateiEXT(buf, srcRGB, dstRGB, srcAlpha, dstAlpha)
}
...
[inline]
pub fn color_maski_ext(buf u32, r byte, g byte, b byte, a byte) {
...
[inline]
pub fn is_enabledi_ext(target u32, index u32) byte {
...
[inline]
pub fn buffer_storage_external_ext(target u32, offset i64, size i64, clientBuffer voidptr, flags u32) {
	C.glBufferStorageExternalEXT(target, offset, size, clientBuffer, flags)
}

[inline]
pub fn named_buffer_storage_external_ext(buffer u32, offset i64, size i64, clientBuffer voidptr, flags u32) {
	C.glNamedBufferStorageExternalEXT(buffer, offset, size, clientBuffer, flags)
}
...
[inline]
pub fn blit_framebuffer_ext(srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glBlitFramebufferEXT(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask,
		filter)
}
...
[inline]
pub fn is_framebuffer_ext(framebuffer u32) byte {
	return C.glIsFramebufferEXT(framebuffer)
}

[inline]
pub fn is_renderbuffer_ext(renderbuffer u32) byte {
...
[inline]
pub fn vertex_attrib_i4ubv_ext(index u32, v &byte) {
...
[inline]
pub fn get_histogram_ext(target u32, reset byte, format u32, gl_type u32, values voidptr) {
...
[inline]
pub fn get_minmax_ext(target u32, reset byte, format u32, gl_type u32, values voidptr) {
...
[inline]
pub fn histogram_ext(target u32, width int, internalformat u32, sink byte) {
	C.glHistogramEXT(target, width, internalformat, sink)
}

[inline]
pub fn minmax_ext(target u32, internalformat u32, sink byte) {
...
[inline]
pub fn create_memory_objects_ext(n int, memoryObjects &u32) {
	C.glCreateMemoryObjectsEXT(n, memoryObjects)
}

[inline]
pub fn delete_memory_objects_ext(n int, memoryObjects &u32) {
	C.glDeleteMemoryObjectsEXT(n, memoryObjects)
}

[inline]
pub fn get_memory_object_parameteriv_ext(memoryObject u32, pname u32, params &int) {
	C.glGetMemoryObjectParameterivEXT(memoryObject, pname, params)
}

[inline]
pub fn get_unsigned_bytei_v_ext(target u32, index u32, data &byte) {
	C.glGetUnsignedBytei_vEXT(target, index, data)
}

[inline]
pub fn get_unsigned_bytev_ext(pname u32, data &byte) {
	C.glGetUnsignedBytevEXT(pname, data)
}

[inline]
pub fn is_memory_object_ext(memoryObject u32) byte {
	return C.glIsMemoryObjectEXT(memoryObject)
}

[inline]
pub fn memory_object_parameteriv_ext(memoryObject u32, pname u32, params &int) {
	C.glMemoryObjectParameterivEXT(memoryObject, pname, params)
}
...
[inline]
pub fn tex_storage_mem1dext(target u32, levels int, internalFormat u32, width int, memory u32, offset u64) {
	C.glTexStorageMem1DEXT(target, levels, internalFormat, width, memory, offset)
}

[inline]
pub fn tex_storage_mem2dext(target u32, levels int, internalFormat u32, width int, height int, memory u32, offset u64) {
	C.glTexStorageMem2DEXT(target, levels, internalFormat, width, height, memory, offset)
}

[inline]
pub fn tex_storage_mem2dmultisample_ext(target u32, samples int, internalFormat u32, width int, height int, fixedSampleLocations byte, memory u32, offset u64) {
	C.glTexStorageMem2DMultisampleEXT(target, samples, internalFormat, width, height,
		fixedSampleLocations, memory, offset)
}

[inline]
pub fn tex_storage_mem3dext(target u32, levels int, internalFormat u32, width int, height int, depth int, memory u32, offset u64) {
	C.glTexStorageMem3DEXT(target, levels, internalFormat, width, height, depth, memory,
		offset)
}

[inline]
pub fn tex_storage_mem3dmultisample_ext(target u32, samples int, internalFormat u32, width int, height int, depth int, fixedSampleLocations byte, memory u32, offset u64) {
	C.glTexStorageMem3DMultisampleEXT(target, samples, internalFormat, width, height,
		depth, fixedSampleLocations, memory, offset)
}

[inline]
pub fn texture_storage_mem1dext(texture u32, levels int, internalFormat u32, width int, memory u32, offset u64) {
	C.glTextureStorageMem1DEXT(texture, levels, internalFormat, width, memory, offset)
}

[inline]
pub fn texture_storage_mem2dext(texture u32, levels int, internalFormat u32, width int, height int, memory u32, offset u64) {
	C.glTextureStorageMem2DEXT(texture, levels, internalFormat, width, height, memory,
		offset)
}

[inline]
pub fn texture_storage_mem2dmultisample_ext(texture u32, samples int, internalFormat u32, width int, height int, fixedSampleLocations byte, memory u32, offset u64) {
	C.glTextureStorageMem2DMultisampleEXT(texture, samples, internalFormat, width, height,
		fixedSampleLocations, memory, offset)
}

[inline]
pub fn texture_storage_mem3dext(texture u32, levels int, internalFormat u32, width int, height int, depth int, memory u32, offset u64) {
	C.glTextureStorageMem3DEXT(texture, levels, internalFormat, width, height, depth,
		memory, offset)
}

[inline]
pub fn texture_storage_mem3dmultisample_ext(texture u32, samples int, internalFormat u32, width int, height int, depth int, fixedSampleLocations byte, memory u32, offset u64) {
	C.glTextureStorageMem3DMultisampleEXT(texture, samples, internalFormat, width, height,
		depth, fixedSampleLocations, memory, offset)
}

[inline]
pub fn import_memory_fd_ext(memory u32, size u64, handleType u32, fd int) {
	C.glImportMemoryFdEXT(memory, size, handleType, fd)
}

[inline]
pub fn import_memory_win32handle_ext(memory u32, size u64, handleType u32, handle voidptr) {
	C.glImportMemoryWin32HandleEXT(memory, size, handleType, handle)
}

[inline]
pub fn import_memory_win32name_ext(memory u32, size u64, handleType u32, name voidptr) {
	C.glImportMemoryWin32NameEXT(memory, size, handleType, name)
}
...
[inline]
pub fn sample_mask_ext(value f32, invert byte) {
...
[inline]
pub fn color_table_ext(target u32, internalFormat u32, width int, format u32, gl_type u32, data voidptr) {
	C.glColorTableEXT(target, internalFormat, width, format, gl_type, data)
}
...
[inline]
pub fn primitive_bounding_box_ext(minX f32, minY f32, minZ f32, minW f32, maxX f32, maxY f32, maxZ f32, maxW f32) {
	C.glPrimitiveBoundingBoxEXT(minX, minY, minZ, minW, maxX, maxY, maxZ, maxW)
}
...
[inline]
pub fn raster_samples_ext(samples u32, fixedsamplelocations byte) {
	C.glRasterSamplesEXT(samples, fixedsamplelocations)
}

[inline]
pub fn getn_uniformfv_ext(program u32, location int, bufSize int, params &f32) {
	C.glGetnUniformfvEXT(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformiv_ext(program u32, location int, bufSize int, params &int) {
	C.glGetnUniformivEXT(program, location, bufSize, params)
}

[inline]
pub fn readn_pixels_ext(x int, y int, width int, height int, format u32, gl_type u32, bufSize int, data voidptr) {
	C.glReadnPixelsEXT(x, y, width, height, format, gl_type, bufSize, data)
}
...
[inline]
pub fn secondary_color3ub_ext(red byte, green byte, blue byte) {
	C.glSecondaryColor3ubEXT(red, green, blue)
}

[inline]
pub fn secondary_color3ubv_ext(v &byte) {
...
[inline]
pub fn is_semaphore_ext(semaphore u32) byte {
...
[inline]
pub fn signal_semaphore_ext(semaphore u32, numBufferBarriers u32, buffers &u32, numTextureBarriers u32, textures &u32, dstLayouts &u32) {
	C.glSignalSemaphoreEXT(semaphore, numBufferBarriers, buffers, numTextureBarriers,
		textures, dstLayouts)
}

[inline]
pub fn wait_semaphore_ext(semaphore u32, numBufferBarriers u32, buffers &u32, numTextureBarriers u32, textures &u32, srcLayouts &u32) {
	C.glWaitSemaphoreEXT(semaphore, numBufferBarriers, buffers, numTextureBarriers, textures,
		srcLayouts)
}

[inline]
pub fn import_semaphore_fd_ext(semaphore u32, handleType u32, fd int) {
	C.glImportSemaphoreFdEXT(semaphore, handleType, fd)
}

[inline]
pub fn import_semaphore_win32handle_ext(semaphore u32, handleType u32, handle voidptr) {
	C.glImportSemaphoreWin32HandleEXT(semaphore, handleType, handle)
}

[inline]
pub fn import_semaphore_win32name_ext(semaphore u32, handleType u32, name voidptr) {
	C.glImportSemaphoreWin32NameEXT(semaphore, handleType, name)
}
...
[inline]
pub fn bind_image_texture_ext(index u32, texture u32, level int, layered byte, layer int, access u32, format int) {
...
[inline]
pub fn tex_page_commitment_ext(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, commit byte) {
	C.glTexPageCommitmentEXT(target, level, xoffset, yoffset, zoffset, width, height,
		depth, commit)
}

[inline]
pub fn texture_page_commitment_ext(texture u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, commit byte) {
...
[inline]
pub fn are_textures_resident_ext(n int, textures &u32, residences &byte) byte {
...
[inline]
pub fn is_texture_ext(texture u32) byte {
...
[inline]
pub fn begin_transform_feedback_ext(primitiveMode u32) {
	C.glBeginTransformFeedbackEXT(primitiveMode)
}
...
[inline]
pub fn get_transform_feedback_varying_ext(program u32, index u32, bufSize int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetTransformFeedbackVaryingEXT(program, index, bufSize, length, size, gl_type,
		name)
}

[inline]
pub fn transform_feedback_varyings_ext(program u32, count int, varyings &&char, bufferMode u32) {
	C.glTransformFeedbackVaryingsEXT(program, count, varyings, bufferMode)
}
...
[inline]
pub fn edge_flag_pointer_ext(stride int, count int, pointer &byte) {
...
[inline]
pub fn gen_symbols_ext(dataType u32, storageType u32, range u32, components u32) u32 {
...
[inline]
pub fn get_invariant_booleanv_ext(id u32, value u32, data &byte) {
...
[inline]
pub fn get_local_constant_booleanv_ext(id u32, value u32, data &byte) {
...
[inline]
pub fn get_variant_booleanv_ext(id u32, value u32, data &byte) {
...
[inline]
pub fn is_variant_enabled_ext(id u32, cap u32) byte {
...
[inline]
pub fn swizzle_ext(res u32, gl_in u32, outX u32, outY u32, outZ u32, outW u32) {
	C.glSwizzleEXT(res, gl_in, outX, outY, outZ, outW)
}
...
[inline]
pub fn variantubv_ext(id u32, addr &byte) {
...
[inline]
pub fn write_mask_ext(res u32, gl_in u32, outX u32, outY u32, outZ u32, outW u32) {
	C.glWriteMaskEXT(res, gl_in, outX, outY, outZ, outW)
}
...
[inline]
pub fn acquire_keyed_mutex_win32ext(memory u32, key u64, timeout u32) byte {
	return C.glAcquireKeyedMutexWin32EXT(memory, key, timeout)
}

[inline]
pub fn release_keyed_mutex_win32ext(memory u32, key u64) byte {
...
[inline]
pub fn edge_flag_pointer_list_ibm(stride int, pointer &&byte, ptrstride int) {
...
[inline]
pub fn begin_perf_query_intel(queryHandle u32) {
	C.glBeginPerfQueryINTEL(queryHandle)
}

[inline]
pub fn create_perf_query_intel(queryId u32, queryHandle &u32) {
	C.glCreatePerfQueryINTEL(queryId, queryHandle)
}

[inline]
pub fn delete_perf_query_intel(queryHandle u32) {
	C.glDeletePerfQueryINTEL(queryHandle)
}

[inline]
pub fn end_perf_query_intel(queryHandle u32) {
	C.glEndPerfQueryINTEL(queryHandle)
}

[inline]
pub fn get_first_perf_query_id_intel(queryId &u32) {
	C.glGetFirstPerfQueryIdINTEL(queryId)
}

[inline]
pub fn get_next_perf_query_id_intel(queryId u32, nextQueryId &u32) {
	C.glGetNextPerfQueryIdINTEL(queryId, nextQueryId)
}

[inline]
pub fn get_perf_counter_info_intel(queryId u32, counterId u32, counterNameLength u32, counterName &char, counterDescLength u32, counterDesc &char, counterOffset &u32, counterDataSize &u32, counterTypeEnum &u32, counterDataTypeEnum &u32, rawCounterMaxValue &u64) {
	C.glGetPerfCounterInfoINTEL(queryId, counterId, counterNameLength, counterName, counterDescLength,
		counterDesc, counterOffset, counterDataSize, counterTypeEnum, counterDataTypeEnum,
		rawCounterMaxValue)
}

[inline]
pub fn get_perf_query_data_intel(queryHandle u32, flags u32, dataSize int, data voidptr, bytesWritten &u32) {
	C.glGetPerfQueryDataINTEL(queryHandle, flags, dataSize, data, bytesWritten)
}

[inline]
pub fn get_perf_query_id_by_name_intel(queryName &char, queryId &u32) {
	C.glGetPerfQueryIdByNameINTEL(queryName, queryId)
}

[inline]
pub fn get_perf_query_info_intel(queryId u32, queryNameLength u32, queryName &char, dataSize &u32, noCounters &u32, noInstances &u32, capsMask &u32) {
	C.glGetPerfQueryInfoINTEL(queryId, queryNameLength, queryName, dataSize, noCounters,
...
[inline]
pub fn debug_message_control(source u32, gl_type u32, severity u32, count int, ids &u32, enabled byte) {
...
[inline]
pub fn get_debug_message_log(count u32, bufSize int, sources &u32, types &u32, ids &u32, severities &u32, lengths &int, messageLog &char) u32 {
	return C.glGetDebugMessageLog(count, bufSize, sources, types, ids, severities, lengths,
		messageLog)
}

[inline]
pub fn get_object_label(identifier u32, name u32, bufSize int, length &int, label &char) {
	C.glGetObjectLabel(identifier, name, bufSize, length, label)
}

[inline]
pub fn get_object_ptr_label(ptr voidptr, bufSize int, length &int, label &char) {
	C.glGetObjectPtrLabel(ptr, bufSize, length, label)
}
...
pub fn getn_uniformfv(program u32, location int, bufSize int, params &f32) {
	C.glGetnUniformfv(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformiv(program u32, location int, bufSize int, params &int) {
	C.glGetnUniformiv(program, location, bufSize, params)
}

[inline]
pub fn getn_uniformuiv(program u32, location int, bufSize int, params &u32) {
	C.glGetnUniformuiv(program, location, bufSize, params)
}

[inline]
pub fn readn_pixels(x int, y int, width int, height int, format u32, gl_type u32, bufSize int, data voidptr) {
	C.glReadnPixels(x, y, width, height, format, gl_type, bufSize, data)
}
...
[inline]
pub fn draw_buffer_region(region u32, x int, y int, width int, height int, xDest int, yDest int) {
	C.glDrawBufferRegion(region, x, y, width, height, xDest, yDest)
}
...
[inline]
pub fn window_pos4d_mesa(x f64, y f64, z f64, xyzabc f64) {
...
[inline]
pub fn async_copy_buffer_sub_data_nvx(waitSemaphoreCount int, waitSemaphoreArray &u32, fenceValueArray &u64, readGpu u32, writeGpuMask u32, readBuffer u32, writeBuffer u32, readOffset i64, writeOffset i64, size i64, signalSemaphoreCount int, signalSemaphoreArray &u32, signalValueArray &u64) voidptr {
	return C.glAsyncCopyBufferSubDataNVX(waitSemaphoreCount, waitSemaphoreArray, fenceValueArray,
...
[inline]
pub fn async_copy_image_sub_data_nvx(waitSemaphoreCount int, waitSemaphoreArray &u32, waitValueArray &u64, srcGpu u32, dstGpuMask u32, srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, srcWidth int, srcHeight int, srcDepth int, signalSemaphoreCount int, signalSemaphoreArray &u32, signalValueArray &u64) u32 {
	return C.glAsyncCopyImageSubDataNVX(waitSemaphoreCount, waitSemaphoreArray, waitValueArray,
		srcGpu, dstGpuMask, srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget,
		dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth, signalSemaphoreCount,
...
[inline]
pub fn lgpucopy_image_sub_data_nvx(sourceGpu u32, destinationGpuMask u32, srcName u32, srcTarget u32, srcLevel int, srcX int, srxY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, width int, height int, depth int) {
	C.glLGPUCopyImageSubDataNVX(sourceGpu, destinationGpuMask, srcName, srcTarget, srcLevel,
		srcX, srxY, srcZ, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, width, height,
		depth)
}
...
[inline]
pub fn lgpunamed_buffer_sub_data_nvx(gpuMask u32, buffer u32, offset i64, size i64, data voidptr) {
	C.glLGPUNamedBufferSubDataNVX(gpuMask, buffer, offset, size, data)
}

[inline]
pub fn client_wait_semaphoreui64nvx(fenceObjectCount int, semaphoreArray &u32, fenceValueArray &u64) {
	C.glClientWaitSemaphoreui64NVX(fenceObjectCount, semaphoreArray, fenceValueArray)
}

[inline]
pub fn signal_semaphoreui64nvx(signalGpu u32, fenceObjectCount int, semaphoreArray &u32, fenceValueArray &u64) {
	C.glSignalSemaphoreui64NVX(signalGpu, fenceObjectCount, semaphoreArray, fenceValueArray)
}

[inline]
pub fn wait_semaphoreui64nvx(waitGpu u32, fenceObjectCount int, semaphoreArray &u32, fenceValueArray &u64) {
	C.glWaitSemaphoreui64NVX(waitGpu, fenceObjectCount, semaphoreArray, fenceValueArray)
}
...
[inline]
pub fn multi_draw_arrays_indirect_bindless_nv(mode u32, indirect voidptr, drawCount int, stride int, vertexBufferCount int) {
	C.glMultiDrawArraysIndirectBindlessNV(mode, indirect, drawCount, stride, vertexBufferCount)
}

[inline]
pub fn multi_draw_elements_indirect_bindless_nv(mode u32, gl_type u32, indirect voidptr, drawCount int, stride int, vertexBufferCount int) {
	C.glMultiDrawElementsIndirectBindlessNV(mode, gl_type, indirect, drawCount, stride,
		vertexBufferCount)
}

[inline]
pub fn multi_draw_arrays_indirect_bindless_count_nv(mode u32, indirect voidptr, drawCount i64, maxDrawCount int, stride int, vertexBufferCount int) {
	C.glMultiDrawArraysIndirectBindlessCountNV(mode, indirect, drawCount, maxDrawCount,
		stride, vertexBufferCount)
}

[inline]
pub fn multi_draw_elements_indirect_bindless_count_nv(mode u32, gl_type u32, indirect voidptr, drawCount i64, maxDrawCount int, stride int, vertexBufferCount int) {
	C.glMultiDrawElementsIndirectBindlessCountNV(mode, gl_type, indirect, drawCount, maxDrawCount,
		stride, vertexBufferCount)
}

[inline]
pub fn get_image_handle_nv(texture u32, level int, layered byte, layer int, format u32) u64 {
...
[inline]
pub fn is_image_handle_resident_nv(handle u64) byte {
	return C.glIsImageHandleResidentNV(handle)
}

[inline]
pub fn is_texture_handle_resident_nv(handle u64) byte {
...
[inline]
pub fn draw_commands_address_nv(primitiveMode u32, indirects &u64, sizes &int, count u32) {
	C.glDrawCommandsAddressNV(primitiveMode, indirects, sizes, count)
}

[inline]
pub fn draw_commands_nv(primitiveMode u32, buffer u32, indirects &i64, sizes &int, count u32) {
	C.glDrawCommandsNV(primitiveMode, buffer, indirects, sizes, count)
}
...
[inline]
pub fn get_command_header_nv(tokenID u32, size u32) u32 {
	return C.glGetCommandHeaderNV(tokenID, size)
}
...
[inline]
pub fn is_command_list_nv(list u32) byte {
	return C.glIsCommandListNV(list)
}

[inline]
pub fn is_state_nv(state u32) byte {
...
[inline]
pub fn copy_image_sub_data_nv(srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, width int, height int, depth int) {
	C.glCopyImageSubDataNV(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget,
...
[inline]
pub fn depth_ranged_nv(zNear f64, zFar f64) {
	C.glDepthRangedNV(zNear, zFar)
}
...
[inline]
pub fn draw_vk_image_nv(vkImage u64, sampler u32, x0 f32, y0 f32, x1 f32, y1 f32, z f32, s0 f32, t0 f32, s1 f32, t1 f32) {
	C.glDrawVkImageNV(vkImage, sampler, x0, y0, x1, y1, z, s0, t0, s1, t1)
}
...
[inline]
pub fn signal_vk_fence_nv(vkFence u64) {
	C.glSignalVkFenceNV(vkFence)
}

[inline]
pub fn signal_vk_semaphore_nv(vkSemaphore u64) {
	C.glSignalVkSemaphoreNV(vkSemaphore)
}

[inline]
pub fn wait_vk_semaphore_nv(vkSemaphore u64) {
	C.glWaitVkSemaphoreNV(vkSemaphore)
}
...
[inline]
pub fn get_map_control_points_nv(target u32, index u32, gl_type u32, ustride int, vstride int, packed byte, points voidptr) {
...
[inline]
pub fn map_control_points_nv(target u32, index u32, gl_type u32, ustride int, vstride int, uorder int, vorder int, packed byte, points voidptr) {
...
[inline]
pub fn is_fence_nv(fence u32) byte {
...
[inline]
pub fn test_fence_nv(fence u32) byte {
...
[inline]
pub fn get_program_named_parameterdv_nv(id u32, len int, name &byte, params &f64) {
	C.glGetProgramNamedParameterdvNV(id, len, name, params)
}

[inline]
pub fn get_program_named_parameterfv_nv(id u32, len int, name &byte, params &f32) {
	C.glGetProgramNamedParameterfvNV(id, len, name, params)
}

[inline]
pub fn program_named_parameter4d_nv(id u32, len int, name &byte, x f64, y f64, z f64, w f64) {
	C.glProgramNamedParameter4dNV(id, len, name, x, y, z, w)
}

[inline]
pub fn program_named_parameter4dv_nv(id u32, len int, name &byte, v &f64) {
	C.glProgramNamedParameter4dvNV(id, len, name, v)
}

[inline]
pub fn program_named_parameter4f_nv(id u32, len int, name &byte, x f32, y f32, z f32, w f32) {
	C.glProgramNamedParameter4fNV(id, len, name, x, y, z, w)
}

[inline]
pub fn program_named_parameter4fv_nv(id u32, len int, name &byte, v &f32) {
	C.glProgramNamedParameter4fvNV(id, len, name, v)
}

[inline]
pub fn blit_framebuffer_nv(srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glBlitFramebufferNV(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask,
		filter)
}
...
[inline]
pub fn renderbuffer_storage_multisample_coverage_nv(target u32, coverageSamples int, colorSamples int, internalformat u32, width int, height int) {
	C.glRenderbufferStorageMultisampleCoverageNV(target, coverageSamples, colorSamples,
		internalformat, width, height)
}
...
[inline]
pub fn multicast_blit_framebuffer_nv(srcGpu u32, dstGpu u32, srcX0 int, srcY0 int, srcX1 int, srcY1 int, dstX0 int, dstY0 int, dstX1 int, dstY1 int, mask u32, filter u32) {
	C.glMulticastBlitFramebufferNV(srcGpu, dstGpu, srcX0, srcY0, srcX1, srcY1, dstX0,
		dstY0, dstX1, dstY1, mask, filter)
}

[inline]
pub fn multicast_buffer_sub_data_nv(gpuMask u32, buffer u32, offset i64, size i64, data voidptr) {
	C.glMulticastBufferSubDataNV(gpuMask, buffer, offset, size, data)
}

[inline]
pub fn multicast_copy_buffer_sub_data_nv(readGpu u32, writeGpuMask u32, readBuffer u32, writeBuffer u32, readOffset i64, writeOffset i64, size i64) {
	C.glMulticastCopyBufferSubDataNV(readGpu, writeGpuMask, readBuffer, writeBuffer, readOffset,
		writeOffset, size)
}

[inline]
pub fn multicast_copy_image_sub_data_nv(srcGpu u32, dstGpuMask u32, srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, srcWidth int, srcHeight int, srcDepth int) {
	C.glMulticastCopyImageSubDataNV(srcGpu, dstGpuMask, srcName, srcTarget, srcLevel,
		srcX, srcY, srcZ, dstName, dstTarget, dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight,
		srcDepth)
}
...
[inline]
pub fn multicast_wait_sync_nv(signalGpu u32, waitGpuMask u32) {
	C.glMulticastWaitSyncNV(signalGpu, waitGpuMask)
}
...
[inline]
pub fn get_internalformat_sampleiv_nv(target u32, internalformat u32, samples int, pname u32, bufSize int, params &int) {
	C.glGetInternalformatSampleivNV(target, internalformat, samples, pname, bufSize, params)
}
...
[inline]
pub fn uniform_matrix2x3fv_nv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2x3fvNV(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix2x4fv_nv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix2x4fvNV(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x2fv_nv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3x2fvNV(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix3x4fv_nv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix3x4fvNV(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x2fv_nv(location int, count int, transpose byte, value &f32) {
	C.glUniformMatrix4x2fvNV(location, count, transpose, value)
}

[inline]
pub fn uniform_matrix4x3fv_nv(location int, count int, transpose byte, value &f32) {
...
[inline]
pub fn is_occlusion_query_nv(id u32) byte {
...
[inline]
pub fn copy_path_nv(resultPath u32, srcPath u32) {
	C.glCopyPathNV(resultPath, srcPath)
}

[inline]
pub fn cover_fill_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, coverMode u32, transformType u32, transformValues &f32) {
	C.glCoverFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, coverMode, transformType,
		transformValues)
}

[inline]
pub fn cover_fill_path_nv(path u32, coverMode u32) {
	C.glCoverFillPathNV(path, coverMode)
}

[inline]
pub fn cover_stroke_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, coverMode u32, transformType u32, transformValues &f32) {
	C.glCoverStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase, coverMode,
		transformType, transformValues)
}

[inline]
pub fn cover_stroke_path_nv(path u32, coverMode u32) {
	C.glCoverStrokePathNV(path, coverMode)
}
...
[inline]
pub fn get_path_commands_nv(path u32, commands &byte) {
...
[inline]
pub fn get_path_dash_array_nv(path u32, dashArray &f32) {
	C.glGetPathDashArrayNV(path, dashArray)
}

[inline]
pub fn get_path_length_nv(path u32, startSegment int, numSegments int) f32 {
	return C.glGetPathLengthNV(path, startSegment, numSegments)
}

[inline]
pub fn get_path_metric_range_nv(metricQueryMask u32, firstPathName u32, numPaths int, stride int, metrics &f32) {
	C.glGetPathMetricRangeNV(metricQueryMask, firstPathName, numPaths, stride, metrics)
}

[inline]
pub fn get_path_metrics_nv(metricQueryMask u32, numPaths int, pathNameType u32, paths voidptr, pathBase u32, stride int, metrics &f32) {
	C.glGetPathMetricsNV(metricQueryMask, numPaths, pathNameType, paths, pathBase, stride,
		metrics)
}
...
[inline]
pub fn get_path_spacing_nv(pathListMode u32, numPaths int, pathNameType u32, paths voidptr, pathBase u32, advanceScale f32, kerningScale f32, transformType u32, returnedSpacing &f32) {
	C.glGetPathSpacingNV(pathListMode, numPaths, pathNameType, paths, pathBase, advanceScale,
		kerningScale, transformType, returnedSpacing)
}

[inline]
pub fn get_path_tex_genfv_nv(texCoordSet u32, pname u32, value &f32) {
	C.glGetPathTexGenfvNV(texCoordSet, pname, value)
}

[inline]
pub fn get_path_tex_geniv_nv(texCoordSet u32, pname u32, value &int) {
	C.glGetPathTexGenivNV(texCoordSet, pname, value)
}

[inline]
pub fn get_program_resourcefv_nv(program u32, programInterface u32, index u32, propCount int, props &u32, bufSize int, length &int, params &f32) {
	C.glGetProgramResourcefvNV(program, programInterface, index, propCount, props, bufSize,
		length, params)
}

[inline]
pub fn interpolate_paths_nv(resultPath u32, pathA u32, pathB u32, weight f32) {
	C.glInterpolatePathsNV(resultPath, pathA, pathB, weight)
}

[inline]
pub fn is_path_nv(path u32) byte {
	return C.glIsPathNV(path)
}

[inline]
pub fn is_point_in_fill_path_nv(path u32, mask u32, x f32, y f32) byte {
	return C.glIsPointInFillPathNV(path, mask, x, y)
}

[inline]
pub fn is_point_in_stroke_path_nv(path u32, x f32, y f32) byte {
	return C.glIsPointInStrokePathNV(path, x, y)
}

[inline]
pub fn matrix_load3x2f_nv(matrixMode u32, m &f32) {
	C.glMatrixLoad3x2fNV(matrixMode, m)
}

[inline]
pub fn matrix_load3x3f_nv(matrixMode u32, m &f32) {
	C.glMatrixLoad3x3fNV(matrixMode, m)
}

[inline]
pub fn matrix_load_transpose3x3f_nv(matrixMode u32, m &f32) {
	C.glMatrixLoadTranspose3x3fNV(matrixMode, m)
}

[inline]
pub fn matrix_mult3x2f_nv(matrixMode u32, m &f32) {
	C.glMatrixMult3x2fNV(matrixMode, m)
}

[inline]
pub fn matrix_mult3x3f_nv(matrixMode u32, m &f32) {
	C.glMatrixMult3x3fNV(matrixMode, m)
}

[inline]
pub fn matrix_mult_transpose3x3f_nv(matrixMode u32, m &f32) {
	C.glMatrixMultTranspose3x3fNV(matrixMode, m)
}

[inline]
pub fn path_color_gen_nv(color u32, genMode u32, colorFormat u32, coeffs &f32) {
	C.glPathColorGenNV(color, genMode, colorFormat, coeffs)
}

[inline]
pub fn path_commands_nv(path u32, numCommands int, commands &byte, numCoords int, coordType u32, coords voidptr) {
	C.glPathCommandsNV(path, numCommands, commands, numCoords, coordType, coords)
}

[inline]
pub fn path_coords_nv(path u32, numCoords int, coordType u32, coords voidptr) {
	C.glPathCoordsNV(path, numCoords, coordType, coords)
}
...
[inline]
pub fn path_dash_array_nv(path u32, dashCount int, dashArray &f32) {
	C.glPathDashArrayNV(path, dashCount, dashArray)
}

[inline]
pub fn path_fog_gen_nv(genMode u32) {
	C.glPathFogGenNV(genMode)
}

[inline]
pub fn path_glyph_index_array_nv(firstPathName u32, fontTarget u32, fontName voidptr, fontStyle u32, firstGlyphIndex u32, numGlyphs int, pathParameterTemplate u32, emScale f32) u32 {
	return C.glPathGlyphIndexArrayNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex,
		numGlyphs, pathParameterTemplate, emScale)
}

[inline]
pub fn path_glyph_index_range_nv(fontTarget u32, fontName voidptr, fontStyle u32, pathParameterTemplate u32, emScale f32, baseAndCount [2]u32) u32 {
	return C.glPathGlyphIndexRangeNV(fontTarget, fontName, fontStyle, pathParameterTemplate,
		emScale, baseAndCount)
}

[inline]
pub fn path_glyph_range_nv(firstPathName u32, fontTarget u32, fontName voidptr, fontStyle u32, firstGlyph u32, numGlyphs int, handleMissingGlyphs u32, pathParameterTemplate u32, emScale f32) {
	C.glPathGlyphRangeNV(firstPathName, fontTarget, fontName, fontStyle, firstGlyph, numGlyphs,
		handleMissingGlyphs, pathParameterTemplate, emScale)
}

[inline]
pub fn path_glyphs_nv(firstPathName u32, fontTarget u32, fontName voidptr, fontStyle u32, numGlyphs int, gl_type u32, charcodes voidptr, handleMissingGlyphs u32, pathParameterTemplate u32, emScale f32) {
	C.glPathGlyphsNV(firstPathName, fontTarget, fontName, fontStyle, numGlyphs, gl_type,
		charcodes, handleMissingGlyphs, pathParameterTemplate, emScale)
}

[inline]
pub fn path_memory_glyph_index_array_nv(firstPathName u32, fontTarget u32, fontSize i64, fontData voidptr, faceIndex int, firstGlyphIndex u32, numGlyphs int, pathParameterTemplate u32, emScale f32) u32 {
	return C.glPathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData,
...
[inline]
pub fn path_string_nv(path u32, format u32, length int, pathString voidptr) {
	C.glPathStringNV(path, format, length, pathString)
}

[inline]
pub fn path_sub_commands_nv(path u32, commandStart int, commandsToDelete int, numCommands int, commands &byte, numCoords int, coordType u32, coords voidptr) {
	C.glPathSubCommandsNV(path, commandStart, commandsToDelete, numCommands, commands,
		numCoords, coordType, coords)
}

[inline]
pub fn path_sub_coords_nv(path u32, coordStart int, numCoords int, coordType u32, coords voidptr) {
	C.glPathSubCoordsNV(path, coordStart, numCoords, coordType, coords)
}

[inline]
pub fn path_tex_gen_nv(texCoordSet u32, genMode u32, components int, coeffs &f32) {
	C.glPathTexGenNV(texCoordSet, genMode, components, coeffs)
}

[inline]
pub fn point_along_path_nv(path u32, startSegment int, numSegments int, distance f32, x &f32, y &f32, tangentX &f32, tangentY &f32) byte {
	return C.glPointAlongPathNV(path, startSegment, numSegments, distance, x, y, tangentX,
		tangentY)
}

[inline]
pub fn program_path_fragment_input_gen_nv(program u32, location int, genMode u32, components int, coeffs &f32) {
	C.glProgramPathFragmentInputGenNV(program, location, genMode, components, coeffs)
}

[inline]
pub fn stencil_fill_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, fillMode u32, mask u32, transformType u32, transformValues &f32) {
	C.glStencilFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, fillMode,
		mask, transformType, transformValues)
}

[inline]
pub fn stencil_fill_path_nv(path u32, fillMode u32, mask u32) {
	C.glStencilFillPathNV(path, fillMode, mask)
}

[inline]
pub fn stencil_stroke_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, reference int, mask u32, transformType u32, transformValues &f32) {
	C.glStencilStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase, reference,
		mask, transformType, transformValues)
}
...
[inline]
pub fn stencil_then_cover_fill_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, fillMode u32, mask u32, coverMode u32, transformType u32, transformValues &f32) {
	C.glStencilThenCoverFillPathInstancedNV(numPaths, pathNameType, paths, pathBase, fillMode,
		mask, coverMode, transformType, transformValues)
}

[inline]
pub fn stencil_then_cover_fill_path_nv(path u32, fillMode u32, mask u32, coverMode u32) {
	C.glStencilThenCoverFillPathNV(path, fillMode, mask, coverMode)
}

[inline]
pub fn stencil_then_cover_stroke_path_instanced_nv(numPaths int, pathNameType u32, paths voidptr, pathBase u32, reference int, mask u32, coverMode u32, transformType u32, transformValues &f32) {
	C.glStencilThenCoverStrokePathInstancedNV(numPaths, pathNameType, paths, pathBase,
		reference, mask, coverMode, transformType, transformValues)
}

[inline]
pub fn stencil_then_cover_stroke_path_nv(path u32, reference int, mask u32, coverMode u32) {
	C.glStencilThenCoverStrokePathNV(path, reference, mask, coverMode)
}

[inline]
pub fn transform_path_nv(resultPath u32, srcPath u32, transformType u32, transformValues &f32) {
	C.glTransformPathNV(resultPath, srcPath, transformType, transformValues)
}

[inline]
pub fn weight_paths_nv(resultPath u32, numPaths int, paths &u32, weights &f32) {
	C.glWeightPathsNV(resultPath, numPaths, paths, weights)
}
...
[inline]
pub fn present_frame_dual_fill_nv(video_slot u32, minPresentTime u64, beginPresentTimeId u32, presentDurationId u32, gl_type u32, target0 u32, fill0 u32, target1 u32, fill1 u32, target2 u32, fill2 u32, target3 u32, fill3 u32) {
	C.glPresentFrameDualFillNV(video_slot, minPresentTime, beginPresentTimeId, presentDurationId,
		gl_type, target0, fill0, target1, fill1, target2, fill2, target3, fill3)
}

[inline]
pub fn present_frame_keyed_nv(video_slot u32, minPresentTime u64, beginPresentTimeId u32, presentDurationId u32, gl_type u32, target0 u32, fill0 u32, key0 u32, target1 u32, fill1 u32, key1 u32) {
	C.glPresentFrameKeyedNV(video_slot, minPresentTime, beginPresentTimeId, presentDurationId,
...
[inline]
pub fn combiner_input_nv(stage u32, portion u32, variable u32, input u32, mapping u32, componentUsage u32) {
	C.glCombinerInputNV(stage, portion, variable, input, mapping, componentUsage)
}

[inline]
pub fn combiner_output_nv(stage u32, portion u32, abOutput u32, cdOutput u32, sumOutput u32, scale u32, bias u32, abDotProduct byte, cdDotProduct byte, muxSum byte) {
	C.glCombinerOutputNV(stage, portion, abOutput, cdOutput, sumOutput, scale, bias, abDotProduct,
		cdDotProduct, muxSum)
}
...
[inline]
pub fn final_combiner_input_nv(variable u32, input u32, mapping u32, componentUsage u32) {
	C.glFinalCombinerInputNV(variable, input, mapping, componentUsage)
}
...
[inline]
pub fn is_buffer_resident_nv(target u32) byte {
	return C.glIsBufferResidentNV(target)
}

[inline]
pub fn is_named_buffer_resident_nv(buffer u32) byte {
...
[inline]
pub fn compressed_tex_image3dnv(target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage3DNV(target, level, internalformat, width, height, depth, border,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image3dnv(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
...
[inline]
pub fn tex_image3dnv(target u32, level int, internalFormat u32, width int, height int, depth int, border int, format u32, gl_type u32, pixels voidptr) {
	C.glTexImage3DNV(target, level, internalFormat, width, height, depth, border, format,
		gl_type, pixels)
}
...
[inline]
pub fn tex_image2dmultisample_coverage_nv(target u32, coverageSamples int, colorSamples int, internalFormat int, width int, height int, fixedSampleLocations byte) {
	C.glTexImage2DMultisampleCoverageNV(target, coverageSamples, colorSamples, internalFormat,
		width, height, fixedSampleLocations)
}

[inline]
pub fn tex_image3dmultisample_coverage_nv(target u32, coverageSamples int, colorSamples int, internalFormat int, width int, height int, depth int, fixedSampleLocations byte) {
	C.glTexImage3DMultisampleCoverageNV(target, coverageSamples, colorSamples, internalFormat,
		width, height, depth, fixedSampleLocations)
}

[inline]
pub fn texture_image2dmultisample_coverage_nv(texture u32, target u32, coverageSamples int, colorSamples int, internalFormat int, width int, height int, fixedSampleLocations byte) {
	C.glTextureImage2DMultisampleCoverageNV(texture, target, coverageSamples, colorSamples,
		internalFormat, width, height, fixedSampleLocations)
}

[inline]
pub fn texture_image2dmultisample_nv(texture u32, target u32, samples int, internalFormat int, width int, height int, fixedSampleLocations byte) {
	C.glTextureImage2DMultisampleNV(texture, target, samples, internalFormat, width, height,
		fixedSampleLocations)
}

[inline]
pub fn texture_image3dmultisample_coverage_nv(texture u32, target u32, coverageSamples int, colorSamples int, internalFormat int, width int, height int, depth int, fixedSampleLocations byte) {
	C.glTextureImage3DMultisampleCoverageNV(texture, target, coverageSamples, colorSamples,
		internalFormat, width, height, depth, fixedSampleLocations)
}

[inline]
pub fn texture_image3dmultisample_nv(texture u32, target u32, samples int, internalFormat int, width int, height int, depth int, fixedSampleLocations byte) {
	C.glTextureImage3DMultisampleNV(texture, target, samples, internalFormat, width, height,
...
[inline]
pub fn begin_transform_feedback_nv(primitiveMode u32) {
	C.glBeginTransformFeedbackNV(primitiveMode)
}
...
[inline]
pub fn get_active_varying_nv(program u32, index u32, bufSize int, length &int, size &int, gl_type &u32, name &char) {
	C.glGetActiveVaryingNV(program, index, bufSize, length, size, gl_type, name)
}
...
[inline]
pub fn transform_feedback_attribs_nv(count u32, attribs &int, bufferMode u32) {
	C.glTransformFeedbackAttribsNV(count, attribs, bufferMode)
}

[inline]
pub fn transform_feedback_varyings_nv(program u32, count int, locations &int, bufferMode u32) {
	C.glTransformFeedbackVaryingsNV(program, count, locations, bufferMode)
}
...
[inline]
pub fn is_transform_feedback_nv(id u32) byte {
...
[inline]
pub fn vdpauget_surfaceiv_nv(surface i64, pname u32, bufSize int, length &int, values &int) {
	C.glVDPAUGetSurfaceivNV(surface, pname, bufSize, length, values)
}

[inline]
pub fn vdpauinit_nv(vdpDevice voidptr, getProcAddress voidptr) {
	C.glVDPAUInitNV(vdpDevice, getProcAddress)
}
...
[inline]
pub fn vdpaumap_surfaces_nv(numSurfaces int, surfaces &i64) {
	C.glVDPAUMapSurfacesNV(numSurfaces, surfaces)
}

[inline]
pub fn vdpauregister_output_surface_nv(vdpSurface voidptr, target u32, numTextureNames int, textureNames &u32) i64 {
	return C.glVDPAURegisterOutputSurfaceNV(vdpSurface, target, numTextureNames, textureNames)
}

[inline]
pub fn vdpauregister_video_surface_nv(vdpSurface voidptr, target u32, numTextureNames int, textureNames &u32) i64 {
	return C.glVDPAURegisterVideoSurfaceNV(vdpSurface, target, numTextureNames, textureNames)
}
...
[inline]
pub fn vdpauunmap_surfaces_nv(numSurface int, surfaces &i64) {
	C.glVDPAUUnmapSurfacesNV(numSurface, surfaces)
}
...
[inline]
pub fn vdpauregister_video_surface_with_picture_structure_nv(vdpSurface voidptr, target u32, numTextureNames int, textureNames &u32, isFrameStructure byte) i64 {
	return C.glVDPAURegisterVideoSurfaceWithPictureStructureNV(vdpSurface, target, numTextureNames,
		textureNames, isFrameStructure)
}
...
[inline]
pub fn vertex_attrib_format_nv(index u32, size int, gl_type u32, normalized byte, stride int) {
...
[inline]
pub fn are_programs_resident_nv(n int, ids &u32, residences &byte) byte {
...
[inline]
pub fn get_program_string_nv(id u32, pname u32, program &byte) {
...
[inline]
pub fn is_program_nv(id u32) byte {
	return C.glIsProgramNV(id)
}

[inline]
pub fn load_program_nv(target u32, id u32, len int, program &byte) {
...
[inline]
pub fn vertex_attrib4ub_nv(index u32, x byte, y byte, z byte, w byte) {
	C.glVertexAttrib4ubNV(index, x, y, z, w)
}

[inline]
pub fn vertex_attrib4ubv_nv(index u32, v &byte) {
...
[inline]
pub fn vertex_attribs4ubv_nv(index u32, n int, v &byte) {
...
[inline]
pub fn is_enabledi_nv(target u32, index u32) byte {
...
[inline]
pub fn blend_equation_separate_oes(modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateOES(modeRGB, modeAlpha)
}

[inline]
pub fn blend_func_separate_oes(sfactorRGB u32, dfactorRGB u32, sfactorAlpha u32, dfactorAlpha u32) {
	C.glBlendFuncSeparateOES(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha)
}
...
[inline]
pub fn copy_image_sub_data_oes(srcName u32, srcTarget u32, srcLevel int, srcX int, srcY int, srcZ int, dstName u32, dstTarget u32, dstLevel int, dstX int, dstY int, dstZ int, srcWidth int, srcHeight int, srcDepth int) {
	C.glCopyImageSubDataOES(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget,
		dstLevel, dstX, dstY, dstZ, srcWidth, srcHeight, srcDepth)
}

[inline]
pub fn blend_equation_separatei_oes(buf u32, modeRGB u32, modeAlpha u32) {
	C.glBlendEquationSeparateiOES(buf, modeRGB, modeAlpha)
}
...
[inline]
pub fn blend_func_separatei_oes(buf u32, srcRGB u32, dstRGB u32, srcAlpha u32, dstAlpha u32) {
	C.glBlendFuncSeparateiOES(buf, srcRGB, dstRGB, srcAlpha, dstAlpha)
}
...
[inline]
pub fn color_maski_oes(buf u32, r byte, g byte, b byte, a byte) {
...
[inline]
pub fn is_enabledi_oes(target u32, index u32) byte {
...
[inline]
pub fn is_framebuffer_oes(framebuffer u32) byte {
	return C.glIsFramebufferOES(framebuffer)
}

[inline]
pub fn is_renderbuffer_oes(renderbuffer u32) byte {
...
[inline]
pub fn get_program_binary_oes(program u32, bufSize int, length &int, binaryFormat &u32, binary voidptr) {
	C.glGetProgramBinaryOES(program, bufSize, length, binaryFormat, binary)
}

[inline]
pub fn program_binary_oes(program u32, binaryFormat u32, binary voidptr, length int) {
	C.glProgramBinaryOES(program, binaryFormat, binary, length)
}
...
[inline]
pub fn unmap_buffer_oes(target u32) byte {
...
[inline]
pub fn compressed_tex_image3does(target u32, level int, internalformat u32, width int, height int, depth int, border int, imageSize int, data voidptr) {
	C.glCompressedTexImage3DOES(target, level, internalformat, width, height, depth, border,
		imageSize, data)
}

[inline]
pub fn compressed_tex_sub_image3does(target u32, level int, xoffset int, yoffset int, zoffset int, width int, height int, depth int, format u32, imageSize int, data voidptr) {
...
[inline]
pub fn tex_image3does(target u32, level int, internalFormat u32, width int, height int, depth int, border int, format u32, gl_type u32, pixels voidptr) {
...
[inline]
pub fn tex_storage3dmultisample_oes(target u32, samples int, internalformat u32, width int, height int, depth int, fixedsamplelocations byte) {
...
[inline]
pub fn is_vertex_array_oes(array u32) byte {
	return C.glIsVertexArrayOES(array)
}

[inline]
pub fn framebuffer_texture_multiview_ovr(target u32, attachment u32, texture u32, level int, baseViewIndex int, numViews int) {
	C.glFramebufferTextureMultiviewOVR(target, attachment, texture, level, baseViewIndex,
		numViews)
}

[inline]
pub fn named_framebuffer_texture_multiview_ovr(framebuffer u32, attachment u32, texture u32, level int, baseViewIndex int, numViews int) {
	C.glNamedFramebufferTextureMultiviewOVR(framebuffer, attachment, texture, level, baseViewIndex,
		numViews)
}

[inline]
pub fn framebuffer_texture_multisample_multiview_ovr(target u32, attachment u32, texture u32, level int, samples int, baseViewIndex int, numViews int) {
...
[inline]
pub fn disable_driver_control_qcom(driverControl u32) {
	C.glDisableDriverControlQCOM(driverControl)
}

[inline]
pub fn enable_driver_control_qcom(driverControl u32) {
	C.glEnableDriverControlQCOM(driverControl)
}

[inline]
pub fn get_driver_control_string_qcom(driverControl u32, bufSize int, length &int, driverControlString &char) {
	C.glGetDriverControlStringQCOM(driverControl, bufSize, length, driverControlString)
}

[inline]
pub fn get_driver_controls_qcom(num &int, size int, driverControls &u32) {
	C.glGetDriverControlsQCOM(num, size, driverControls)
}
...
[inline]
pub fn ext_get_buffers_qcom(buffers &u32, maxBuffers int, numBuffers &int) {
	C.glExtGetBuffersQCOM(buffers, maxBuffers, numBuffers)
}

[inline]
pub fn ext_get_framebuffers_qcom(framebuffers &u32, maxFramebuffers int, numFramebuffers &int) {
	C.glExtGetFramebuffersQCOM(framebuffers, maxFramebuffers, numFramebuffers)
}

[inline]
pub fn ext_get_renderbuffers_qcom(renderbuffers &u32, maxRenderbuffers int, numRenderbuffers &int) {
	C.glExtGetRenderbuffersQCOM(renderbuffers, maxRenderbuffers, numRenderbuffers)
}
...
[inline]
pub fn ext_get_textures_qcom(textures &u32, maxTextures int, numTextures &int) {
	C.glExtGetTexturesQCOM(textures, maxTextures, numTextures)
}
...
[inline]
pub fn ext_get_programs_qcom(programs &u32, maxPrograms int, numPrograms &int) {
	C.glExtGetProgramsQCOM(programs, maxPrograms, numPrograms)
}

[inline]
pub fn ext_get_shaders_qcom(shaders &u32, maxShaders int, numShaders &int) {
	C.glExtGetShadersQCOM(shaders, maxShaders, numShaders)
}

[inline]
pub fn ext_is_program_binary_qcom(program u32) byte {
	return C.glExtIsProgramBinaryQCOM(program)
}

[inline]
pub fn framebuffer_foveation_config_qcom(fbo u32, numLayers u32, focalPointsPerLayer u32, requestedFeatures u32, providedFeatures &u32) {
	C.glFramebufferFoveationConfigQCOM(fbo, numLayers, focalPointsPerLayer, requestedFeatures,
		providedFeatures)
}

[inline]
pub fn framebuffer_foveation_parameters_qcom(fbo u32, layer u32, focalPoint u32, focalX f32, focalY f32, gainX f32, gainY f32, foveaArea f32) {
	C.glFramebufferFoveationParametersQCOM(fbo, layer, focalPoint, focalX, focalY, gainX,
		gainY, foveaArea)
}
...
[inline]
pub fn texture_foveation_parameters_qcom(texture u32, layer u32, focalPoint u32, focalX f32, focalY f32, gainX f32, gainY f32, foveaArea f32) {
	C.glTextureFoveationParametersQCOM(texture, layer, focalPoint, focalX, focalY, gainX,
		gainY, foveaArea)
}

[inline]
pub fn end_tiling_qcom(preserveMask u32) {
	C.glEndTilingQCOM(preserveMask)
}

[inline]
pub fn start_tiling_qcom(x u32, y u32, width u32, height u32, preserveMask u32) {
	C.glStartTilingQCOM(x, y, width, height, preserveMask)
}
...
[inline]
pub fn depth_rangex(zNear int, zFar int) {
	C.glDepthRangex(zNear, zFar)
}
...
[inline]
pub fn frustumf(left f32, right f32, bottom f32, top f32, zNear f32, zFar f32) {
	C.glFrustumf(left, right, bottom, top, zNear, zFar)
}

[inline]
pub fn frustumx(left int, right int, bottom int, top int, zNear int, zFar int) {
	C.glFrustumx(left, right, bottom, top, zNear, zFar)
}
...
[inline]
pub fn orthof(left f32, right f32, bottom f32, top f32, zNear f32, zFar f32) {
	C.glOrthof(left, right, bottom, top, zNear, zFar)
}

[inline]
pub fn orthox(left int, right int, bottom int, top int, zNear int, zFar int) {
	C.glOrthox(left, right, bottom, top, zNear, zFar)
}
...
[inline]
pub fn sample_coveragex(value int, invert byte) {
...
[inline]
pub fn get_extension_regal(ext &char) byte {
	return C.glGetExtensionREGAL(ext)
}

[inline]
pub fn is_supported_regal(ext &char) byte {
	return C.glIsSupportedREGAL(ext)
}

[inline]
pub fn log_message_callback_regal(callback voidptr) {
...
[inline]
pub fn sample_mask_sgis(value f32, invert byte) {
...
[inline]
pub fn is_async_marker_sgix(marker u32) byte {
...
[inline]
pub fn get_mpegquant_tableubv(target u32, values &byte) {
	C.glGetMPEGQuantTableubv(target, values)
}

[inline]
pub fn is_mpegpredictor_sgix(predictor u32) byte {
...
[inline]
pub fn mpegquant_tableubv(target u32, values &byte) {
...
[inline]
pub fn are_vertex_arrays_resident_sgix(n int, arrays &u32, residences &byte) byte {
...
[inline]
pub fn is_vertex_array_sgix(array u32) byte {
...
[inline]
pub fn global_alpha_factorub_sun(factor byte) {
...
[inline]
pub fn replacement_codeub_sun(code byte) {
	C.glReplacementCodeubSUN(code)
}

[inline]
pub fn replacement_codeubv_sun(code &byte) {
...
[inline]
pub fn color4ub_vertex2f_sun(r byte, g byte, b byte, a byte, x f32, y f32) {
	C.glColor4ubVertex2fSUN(r, g, b, a, x, y)
}

[inline]
pub fn color4ub_vertex2fv_sun(c &byte, v &f32) {
	C.glColor4ubVertex2fvSUN(c, v)
}

[inline]
pub fn color4ub_vertex3f_sun(r byte, g byte, b byte, a byte, x f32, y f32, z f32) {
	C.glColor4ubVertex3fSUN(r, g, b, a, x, y, z)
}

[inline]
pub fn color4ub_vertex3fv_sun(c &byte, v &f32) {
...
[inline]
pub fn replacement_codeui_color4ub_vertex3f_sun(rc u32, r byte, g byte, b byte, a byte, x f32, y f32, z f32) {
	C.glReplacementCodeuiColor4ubVertex3fSUN(rc, r, g, b, a, x, y, z)
}

[inline]
pub fn replacement_codeui_color4ub_vertex3fv_sun(rc &u32, c &byte, v &f32) {
...
[inline]
pub fn tex_coord2f_color4ub_vertex3f_sun(s f32, t f32, r byte, g byte, b byte, a byte, x f32, y f32, z f32) {
	C.glTexCoord2fColor4ubVertex3fSUN(s, t, r, g, b, a, x, y, z)
}

[inline]
pub fn tex_coord2f_color4ub_vertex3fv_sun(tc &f32, c &byte, v &f32) {
...
[inline]
pub fn are_textures_resident(n int, textures &u32, residences &byte) byte {
...
[inline]
pub fn bitmap(width int, height int, xorig f32, yorig f32, xmove f32, ymove f32, bitmap &byte) {
...
[inline]
pub fn color_mask(red byte, green byte, blue byte, alpha byte) {
...
[inline]
pub fn copy_tex_image1d(target u32, level int, internalFormat u32, x int, y int, width int, border int) {
	C.glCopyTexImage1D(target, level, internalFormat, x, y, width, border)
}

[inline]
pub fn copy_tex_image2d(target u32, level int, internalFormat u32, x int, y int, width int, height int, border int) {
...
[inline]
pub fn depth_mask(flag byte) {
	C.glDepthMask(flag)
}

[inline]
pub fn depth_range(zNear f64, zFar f64) {
...
[inline]
pub fn get_booleanv(pname u32, params &byte) {
...
[inline]
pub fn get_polygon_stipple(mask &byte) {
	C.glGetPolygonStipple(mask)
}

[inline]
pub fn get_string(name u32) &byte {
...
[inline]
pub fn indexub(c byte) {
	C.glIndexub(c)
}

[inline]
pub fn indexubv(c &byte) {
	C.glIndexubv(c)
}
...
[inline]
pub fn is_enabled(cap u32) byte {
	return C.glIsEnabled(cap)
}

[inline]
pub fn is_list(list u32) byte {
	return C.glIsList(list)
}

[inline]
pub fn is_texture(texture u32) byte {
...
[inline]
pub fn polygon_stipple(mask &byte) {
...
[inline]
pub fn glew_is_supported(name &char) byte {
	return C.glewIsSupported(name)
}

[inline]
pub fn glew_get_extension(name &char) byte {
	return C.glewGetExtension(name)
}

[inline]
pub fn glew_get_error_string(error u32) &byte {
	return C.glewGetErrorString(error)
}

[inline]
pub fn glew_get_string(name u32) &byte {
